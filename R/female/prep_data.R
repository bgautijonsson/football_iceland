...
write_csv(
  model_d,
  here("results", "female", "model_d.csv")
)
...
write_csv(
  top_teams,
  here("results", "female", "top_teams.csv")
)
...
write_csv(
  next_games,
  here("results", "female", "next_games.csv")
)
...
write_csv(
  pred_d,
  here("results", "female", "pred_d.csv")
)
